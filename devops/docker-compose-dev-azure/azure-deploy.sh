...
resourcename="securitycompliance"  # lower case, only
resourcegroup="securitycompliance_rg"
...
# git clone https://github.com/apilogicserver/securitycompliance.git
# cd securitycompliance
...
az group create --name securitycompliance_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group securitycompliance_rg --sku S1 --is-linux
az container create --resource-group securitycompliance_rg --name securitycompliance --image apilogicserver/securitycompliance:latest --dns-name-label securitycompliance --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//securitycompliance.westus.azurecontainer.io:5656'
