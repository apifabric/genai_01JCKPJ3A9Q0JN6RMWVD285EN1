...
@Component({
  selector: 'ComplianceRequirement-home',
  templateUrl: './ComplianceRequirement-home.component.html',
  styleUrls: ['./ComplianceRequirement-home.component.scss']
})
export class ComplianceRequirementHomeComponent implements AfterViewInit {
