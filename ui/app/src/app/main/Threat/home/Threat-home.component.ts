...
@Component({
  selector: 'Threat-home',
  templateUrl: './Threat-home.component.html',
  styleUrls: ['./Threat-home.component.scss']
})
export class ThreatHomeComponent implements AfterViewInit {
